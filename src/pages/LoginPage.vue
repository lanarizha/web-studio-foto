    ...
    <div class="max-w-md w-full">
      ...
      <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 space-y-8">
        ...
        <div class="text-center space-y-3">
          <div
            class="mx-auto w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center mb-4"
          >
            <svg
          ...
          <p class="text-gray-600 text-sm">Masuk dengan akun Google Anda</p>
        </div>
